...
export function SiteFooter() {
  return (
    <footer className="relative z-10 mt-12 border-t border-border bg-background/80">
      <div className="mx-auto flex w-full max-w-[var(--content-max-width)] flex-col gap-4 px-4 py-6 text-sm text-slate-400 sm:flex-row sm:items-center sm:justify-between sm:px-6">
